...
st.set_page_config(
    page_title="AI-Powered Skin Disease Detection",
    layout="wide",
    page_icon="🩺",
...
<div class="gradient-header">
    <h1 style="color: #2d3748;">🩺 SkinDiseaseAI</h1>
    <p style="color: #4a5568; font-weight: 500;">Advanced AI-Powered Skin Disease Detection Platform</p>
</div>
